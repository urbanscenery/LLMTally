...
extension Theme {
    ...
    static let sharedPresets: [Theme] = [
        make("catppuccin", "Catppuccin Mocha", accent: 0xCAA0FD, live: 0xA2E89C, warn: 0xFFE4A9, crit: 0xFB83A5, spend: 0xFB83A5, quota: 0x84B3FF, background: 0x1E1E2E, dark: true),
        ...
        make("tokyo-night", "Tokyo Night", accent: 0x9B75DF, live: 0x9ED662, warn: 0xE9B15F, crit: 0xFF6E89, spend: 0xFF9E64, quota: 0x729FFF, background: 0x1A1B26, dark: true),
        make("dracula", "Dracula", accent: 0xFF79C6, live: 0x4BFF79, warn: 0xFFB86C, crit: 0xFF5555, spend: 0xBC8DFF, quota: 0x89EAFF, background: 0x282A36, dark: true),
        ...
        make("material", "Material Dark", accent: 0xC88BF1, live: 0xC4EF86, warn: 0xFFCB6B, crit: 0xFA6770, spend: 0xFF8864, quota: 0x82AAFF, background: 0x263238, dark: true),
        make("night-owl", "Night Owl", accent: 0x82AAFF, live: 0xAFE45E, warn: 0xF3C586, crit: 0xFB4844, spend: 0xFF8864, quota: 0xC88BF1, background: 0x011627, dark: true),
        ...
        make("mono-dark", "Mono Dark", accent: 0xEEEEEE, live: 0xCFCFCF, warn: 0x8A8A8A, crit: 0xFFFFFF, spend: 0xB0B0B0, quota: 0x888888, background: 0x000000, dark: true),
        make("github", "GitHub Light", accent: 0xDC1523, live: 0x128734, warn: 0x9A6700, crit: 0xAF031E, spend: 0xBC4C00, quota: 0x0068E3, background: 0xFFFFFF, dark: false),
        ...
        make("night-owl-light", "Night Owl Light", accent: 0x3D72E1, live: 0x00996D, warn: 0xDBAB00, crit: 0xEA312F, spend: 0xD0605E, quota: 0x9C43CC, background: 0xFBFBFB, dark: false),
        ...
        make("mono-light", "Mono Light", accent: 0x111111, live: 0x333333, warn: 0x777777, crit: 0x000000, spend: 0x555555, quota: 0x999999, background: 0xFFFFFF, dark: false),
    ]
